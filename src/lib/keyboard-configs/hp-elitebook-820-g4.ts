...
/**
 * Keyboard button configuration for HP EliteBook 820 G4
 * Secondary keys are left empty if they are icons/function keys (to be filled manually)
 */
export const hpEliteBook820G4Config: KeyboardButtonConfig = [
  // Row 1 - Function keys
  { id: 'esc', primary: 'Escape', secondary: '', fn: '' },
  { id: 'f1', primary: 'F1', secondary: '', fn: 'SleepMode' }, // Icon: moon
  { id: 'f2', primary: 'F2', secondary: '', fn: '' },
  { id: 'f3', primary: 'F3', secondary: '', fn: 'BacklightToggle' }, // Icon: custom
  { id: 'f4', primary: 'F4', secondary: '', fn: 'DisplayModeSwitch' }, // Icon: custom
  { id: 'f5', primary: 'F5', secondary: '', fn: 'Brightness-' }, // Icon: brightness
  { id: 'f6', primary: 'F6', secondary: '', fn: 'Brightness+' }, // Icon: brightness
  { id: 'f7', primary: 'F7', secondary: '', fn: 'VolumeMute' }, // Icon: projector
  { id: 'f8', primary: 'F8', secondary: '', fn: 'Volume-' }, // Icon: screen
  { id: 'f9', primary: 'F9', secondary: '', fn: 'Volume+' }, // Icon: volume
  { id: 'f10', primary: 'F10', secondary: '', fn: 'MicToggle' }, // Icon: mic
  { id: 'f11', primary: 'F11', secondary: '', fn: 'WifiToggle' }, // Icon: volume
  { id: 'f12', primary: 'F12', secondary: '', fn: 'NumLock' },
  { id: 'insert', primary: 'Insert', secondary: '', fn: 'PrintScreen' },
  ...
  { id: 'shift-right', primary: 'Shift', secondary: '', fn: 'Pause' },
  ...
  { id: 'ctrl-right', primary: 'Control', secondary: '', fn: '' }, // Menu key
  { id: 'arrow-left', primary: 'ArrowLeft', secondary: '', fn: 'Home' },
  { id: 'arrow-up', primary: 'ArrowUp', secondary: '', fn: 'PageUp' },
  { id: 'arrow-down', primary: 'ArrowDown', secondary: '', fn: 'PageDown' },
